...
export const QUESTIONNAIRE_STEPS: { title: string; subtitle: string; questions: QuestionConfig[] }[] = [
  {
    title: 'Energy & Sleep',
...
export const DEFAULT_QUESTIONNAIRE = {
  ...
  dailyWaterIntake: 3,
  sunlightExposure: 3,
  foodPattern: 'mixed' as const,
  eggFrequency: 'sometimes' as const,
  dairyFrequency: 'sometimes' as const,
  leafyGreensFrequency: 'sometimes' as const,
  legumesFrequency: 'sometimes' as const,
  meatFrequency: 'sometimes' as const,
  mealRegularity: 3,
  exerciseLevel: 3,
  hairFall: false,
  skinDullness: false,
